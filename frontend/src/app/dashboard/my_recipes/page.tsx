...
export default function AddRecipePage() {
  ...
  const saveIngredient = () => {
    console.log('popupIngredient:', popupIngredient);  // Log the whole object to inspect its structure
  ...
  const editIngredient = (index: number) => {
    ...
    setPopupIngredient({ ...defaultIngredient, ...ingredients[index] });
      ...
      {isPopupOpen && (
        <div style={popupOverlayStyle}>
          <div style={popupContentStyle}>
            ...
            {['name', 'calories', 'fats', 'carbs', 'sodium', 'sugar'].map((field) => (
              <div key={field} style={{ marginBottom: '10px' }}>
                ...
                <input
                  type="text"
                  placeholder={field}
                  value={String(popupIngredient[field as keyof Ingredient] ?? '')}
